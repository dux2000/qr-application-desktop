...
import { DatePicker, DateTimePicker, DateTimePickerProps, DateTimeValidationError, PickerChangeHandlerContext, renderTimeViewClock } from '@mui/x-date-pickers';
...
interface StyledDatePickerProps extends DateTimePickerProps<Dayjs> {
    hasInputValue?: boolean;
    isFocused?: boolean
    errorMessage?: string | undefined
}

const CssInputDate = styled(DatePicker)<StyledDatePickerProps>((props) => ({
    '& .MuiFormLabel-root': {
